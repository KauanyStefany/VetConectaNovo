#!/usr/bin/env python3
"""
Script para gerar todas as 94 imagens das postagens do feed
"""
import json
import subprocess
import time
...
# Prompts otimizados para cada postagem
PROMPTS = {
...
print(f"\nFaltam gerar: {missing}")

# Gerar comandos para as faltantes
print("\n" + "="*80)
print("INSTRUÇÕES MANUAIS:")
print("="*80)
print("\nCopie e execute os comandos abaixo no Claude Code para gerar as imagens faltantes.")
print("Faça em lotes de 4 imagens por vez.\n")

for i, post_id in enumerate(missing):
    prompt = PROMPTS.get(post_id, "realistic photo, pet photography, natural lighting")
    print(f"# Postagem {post_id}")
    print(f'mcp__runware__generate_image: prompt="{prompt}, high quality, photorealistic", width=512, height=512')
    if (i + 1) % 4 == 0:
        print("\n# Aguarde as 4 imagens acima serem geradas, depois baixe-as e continue...\n")
