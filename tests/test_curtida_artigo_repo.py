...
from app.database.models.curtida_artigo_model import CurtidaArtigo
...
from app.database.repositories import categoria_artigo_repo, usuario_repo, postagem_artigo_repo, curtida_artigo_repo, veterinario_repo
...
class TestCurtidaArtigoRepo:
    ...
    def test_excluir_curtida(self, test_db):
        ...
        curtida_excluida = curtida_artigo_repo.obter_por_id(id_usuario, id_postagem)
        assert curtida_excluida is None, "A curtida excluída deveria ser None"