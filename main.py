...
from routes.tutor import comentario_tutor_routes, curtida_artigo_tutor_routes, curtida_feed_tutor_routes, dados_tutor_routes, denuncia_tutor_routes, postagem_feed_routes
from routes.veterinario import comentario_veterinario_routes, dados_veterinario_routes, estatisticas_routes, postagem_artigo_routes, solicitacao_crmv_routes
...
app.include_router(dados_tutor_routes.router, prefix="/veterinario", tags=["veterinario"])
...
app.include_router(dados_veterinario_routes.router, prefix="/veterinario", tags=["veterinario"])
