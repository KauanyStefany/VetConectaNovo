...
```
{
  ...
  "tests/test_usuario_repo.py::TestUsuarioRepo::test_criar_tabela": true,
...
```
[
  "tests/test_usuario_repo.py::TestUsuarioRepo::test_atualizar_usuario",
  "tests/test_usuario_repo.py::TestUsuarioRepo::test_criar_tabela",
  "tests/test_usuario_repo.py::TestUsuarioRepo::test_inserir_usuario"
]
```
...
```
{
  "tests/test_denuncia_repo.py::TestDenunciaRepo::test_obter_denuncia_por_id": true,
  "tests/test_denuncia_repo.py::TestDenunciaRepo::test_criar_tabela_denuncia": true,
  "tests/test_denuncia_repo.py::TestDenunciaRepo::test_inserir_denuncia": true,
  "tests/test_denuncia_repo.py::TestDenunciaRepo::test_atualizar_denuncia": true,
  "tests/test_denuncia_repo.py::TestDenunciaRepo::test_excluir_denuncia": true,
  "tests/test_denuncia_repo.py::TestDenunciaRepo::test_obter_todas_denuncias_paginadas": true,
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_obter_todos_veterinarios": true,
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_criar_tabela": true,
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_inserir_veterinario": true,
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_atualizar_veterinario": true,
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_excluir_veterinario": true,
  "tests/test_postagem_artigo.py::TestPostagemArtigoRepo::test_criar_tabela": true,
  "tests/test_postagem_artigo.py::TestPostagemArtigoRepo::test_inserir_postagem_artigo": true,
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_obter_veterinario_por_id": true,
...
[
  ...
  "tests/test_denuncia_repo.py::TestDenunciaRepo::test_atualizar_denuncia",
  "tests/test_denuncia_repo.py::TestDenunciaRepo::test_excluir_denuncia",
  "tests/test_denuncia_repo.py::TestDenunciaRepo::test_inserir_denuncia",
  "tests/test_denuncia_repo.py::TestDenunciaRepo::test_obter_denuncia_por_id",
  "tests/test_denuncia_repo.py::TestDenunciaRepo::test_obter_todas_denuncias_paginadas",
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_atualizar_veterinario",
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_criar_tabela",
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_excluir_veterinario",
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_inserir_veterinario",
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_obter_todos_veterinarios",
  "tests/test_veterinario_repo.py::TestVeterinarioRepo::test_obter_veterinario_por_id"
]
```
