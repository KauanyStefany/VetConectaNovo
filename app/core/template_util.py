...
def criar_templates(diretorio_especifico: Optional[Union[str, List[str]]] = None) -> Jinja2Templates:
    ...
    O diretório raiz "app/templates" é sempre incluído automaticamente para garantir
    acesso aos app/templates base como base.html.
    
    Args:
        diretorio_especifico: Diretório(s) específico(s) além do raiz.
                             Pode ser uma string única ou lista de strings.
                             Exemplo: "app/templates/admin/categorias" ou
                                     ["app/templates/admin", "app/templates/public"]
    ...
    Exemplo de uso:
        ...
        templates = criar_templates("app/templates/admin/categorias")

        # Para múltiplos diretórios
        templates = criar_templates(["app/templates/admin", "app/templates/admin/produtos"])

        # Apenas com o diretório raiz
        templates = criar_templates()
    """
    # Sempre incluir o diretório raiz onde estão os templates base
    diretorios = ["app/templates"]
